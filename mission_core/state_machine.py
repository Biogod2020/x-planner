...
def require_evidence_for_terminal_task(status: TaskStatus, evidence_count: int) -> None:
    if status in {TaskStatus.COMPLETED, TaskStatus.ACCEPTED} and evidence_count < 1:
        raise ValueError("task cannot be completed or accepted without evidence")
